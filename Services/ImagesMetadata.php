...
class ImagesMetadata
{
    ...
    private function updateAttachmentFields($attachment_id)
    {
        ...
        //output_log(['updateAttachmentFields', $attachment_id, $attachment]);
        ...
        //output_log([' - addAttachment ALT', $post_excerpt]);
        update_post_meta($attachment_id, '_wp_attachment_image_alt', $post_excerpt);

        // Set the image meta (e.g. Title, Excerpt, Content)
        //output_log([' - addAttachment POST', $post_title, $post_content, $post_excerpt]);
        wp_update_post([
            'ID' => $attachment_id,
